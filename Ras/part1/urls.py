...
urlpatterns = [
    ...
    path('Page1Razdel/Page1CoupleWays1/', TemplateView.as_view(template_name='Page1/RazdelCouple/Page1CoupleWays1.html')),
    path('Page1Razdel/Page1CoupleWays2/', TemplateView.as_view(template_name='Page1/RazdelCouple/Page1CoupleWays2.html')),
    path('Page1Razdel/Page1CoupleSostav1/', TemplateView.as_view(template_name='Page1/RazdelCouple/Page1CoupleSostav1.html')),
    path('Page1Razdel/Page1CoupleSostav2/', TemplateView.as_view(template_name='Page1/RazdelCouple/Page1CoupleSostav2.html')),
    path('Page1Razdel/Page1CoupleRecogn1/', TemplateView.as_view(template_name='Page1/RazdelCouple/Page1CoupleRecogn1.html')),
    path('Page1Razdel/Page1CoupleRecogn2/', TemplateView.as_view(template_name='Page1/RazdelCouple/Page1CoupleRecogn2.html')),
    path('Page1Razdel/Page1CoupleTimeMarsh1/', TemplateView.as_view(template_name='Page1/RazdelCouple/Page1CoupleTimeMarsh1.html')),
    path('Page1Razdel/Page1CoupleTimeMarsh2/', TemplateView.as_view(template_name='Page1/RazdelCouple/Page1CoupleTimeMarsh2.html')),
    path('Page1Razdel/Page1CoupleTimeRazv1/', TemplateView.as_view(template_name='Page1/RazdelCouple/Page1CoupleTimeRazv1.html')),
    path('Page1Razdel/Page1CoupleTimeRazv2/', TemplateView.as_view(template_name='Page1/RazdelCouple/Page1CoupleTimeRazv2.html')),
    path('Page1Razdel/Page1CoupleFinal/', TemplateView.as_view(template_name='Page1/RazdelCouple/Page1CoupleFinal.html')),
